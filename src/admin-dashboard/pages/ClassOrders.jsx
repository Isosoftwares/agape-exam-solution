...
function ClassOrders() {
  ...
  const getClientOrders = async () => {
    return await axios.get(
      `/classes?page=${activePage}&perPage=${perPage}&status=${status}&assignedWriter=${assignedWriter}`
    );
  };
  ...
  return (
    <div>
      <p className="font-bold text-lg ">Classes Orders </p>
      {/* filters */}
      <div className="bg-light py-4 px-2 rounded  ">
        ...
        <div className="flex justify-between items-center">
          <p>{classesData?.data?.count || 0} Result</p>
          <button
