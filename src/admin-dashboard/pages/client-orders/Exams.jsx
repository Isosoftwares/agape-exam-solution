...
function Exams({ clientId }) {
  ...
  const getClientOrders = async () => {
    return await axios.get(
      `/exams?page=${activePage}&perPage=${perPage}&status=${status}&clientId=${clientId}`
    );
  };
  ...
  return (
    <div>
      <p className="font-bold">Exam Orders </p>
