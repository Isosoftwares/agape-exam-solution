  ...
  return (
    <div className="">
      ...
      <div className=" flex h-screen  bg-gray-100">
        ...
        >
          {/* header */}
          <div className="flex absolute z-60  top-0 right-0 left-0 bg-light shadow-sm shadow-light border-b-2 border-b-cyan-50 justify-between items-center px-3 py-5">
            <div className="flex ">
              ...
              <div>
                <p className="">Welcome back, {auth?.userName}</p>
              </div>
            </div>
          ...
          <main className=" h-screen overflow-y-auto no-scrollbar pt-[90px] px-4 ">
            <Outlet />
          </main>
          {/* <footer>
