              ...
              usersData?.data?.users?.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="px-6 font-bold text- py-4 capitalize">
                      {item?.userName}
                    </td>
                    ...
                    <td className="px-6  ">
                      <div className="flex items-center flex-wrap gap-2">
                        <div>
                          ...
                          <Link
                          to={`/dashboard/users/writer/${item?._id}`}
                            className={` px-4 cursor-pointer py-2 mx-2 bg-secondary text-light rounded disabled:cursor-not-allowed `}
                          >
                           View
                          </Link>
                        </div>
