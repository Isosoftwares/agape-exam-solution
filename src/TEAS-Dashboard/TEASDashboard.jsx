  ...
  return (
    <div className="">
      ...
      <div className=" flex  bg-gray-100">
        ...
        >
          {/* header */}
          <div className="flex absolute z-40 top-0 right-0 left-0 bg-light shadow-sm shadow-light border-b-2 border-b-cyan-50 justify-between items-center px-3 py-5">
            <div className="flex ">
              ...
              <div>
                <p className="text-sm">Welcome back {auth?.userName} </p>
          ...
          <main className=" h-[100vh] overflow-y-auto no-scrollbar pt-[90px] px-4 ">
            <Outlet />
          </main>
          {/* <footer>
