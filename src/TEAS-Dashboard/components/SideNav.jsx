...
function SideNav({ mobileMenu, handleMenu }) {
      ...
      links: [
        {
          ...
          path: "/teas/test/Priority Premium Test",
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "Bonus Practice Test",
          path: "/teas/test/Bonus Practice Test",
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "Take Teas On my Behalf",
          path: "/teas/take-my-test/teas",
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "My TEAS Exams",
          path: "/teas/exams/TEAS",
          icon: <FaAngleRight size={18} />,
        },
      ],
    },
  ...
  const subscription = getSubscription(auth.subscription, "TEAS");
      ...
      >
        <Link to={"/"}>
          <div className="bg-primary w-full px-2 py-4">
            ...
            <p className="text-3xl font-bold text-light">TEAS</p>
