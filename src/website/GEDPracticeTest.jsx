...
function GEDPracticeTest() {
  const [selectedSubject, setSelectedSubject] = useState("");
  const [perPage, setPerPage] = useState(20);
  const [activePage, setPage] = useState(1);
  const [examType, setExamType] = useState("GED");
  ...
  return (
    <div className="min-h-screen bg-light">
        ...
        <div className="relative container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="pt-4">
              <Link
                onClick={() => {
                  localStorage.setItem("dotestCalculator", "GED");
                }}
                to="/my-test"
              ...
              >
                <span className="relative z-10">Take My GED Exam</span>
                <svg
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl lg:text-4xl font-black text-primary mb-6">
                  Why Choose Our GED Program?
                  <div className="w-16 h-1 bg-secondary rounded-full mt-3"></div>
                </h2>

                <p className="text-dark/80 text-lg leading-relaxed mb-8">
                  At Agape Smart Solutions, we are dedicated to helping students
                  succeed in their GED exams. Our comprehensive approach ensures
                  that each student receives the support and resources they need
                  to excel.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  "Progress assessment to track achievements and highlight areas for enhancement",
                ].map((feature, index) => (
      ...
      <section id="subscriptions" className="py-16 bg-tertiary/10">
        <div className="container mx-auto px-4 lg:px-8">
          <Subscriptions close={false} serviceName="GED" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-dark/70 text-lg max-w-2xl mx-auto">
              Access our comprehensive collection of practice tests designed to
              help you succeed
            </p>
          </div>
...
export default GEDPracticeTest;
