  ...
  return (
    <div className="min-h-screen bg-light">
        ...
        <div className="relative container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-secondary text-sm font-medium">
              ...
              <span>HESI Test Preparation</span>
            </div>
            ...
            <div className="pt-4">
              <Link
                onClick={() => {
                  localStorage.setItem("dotestCalculator", "HESI");
                }}
                to="/my-test"
              ...
              >
                <span className="relative z-10">Take My HESI Exam</span>
                <svg
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl lg:text-4xl font-black text-primary mb-6">
                  Why Choose Our HESI Program?
                  <div className="w-16 h-1 bg-secondary rounded-full mt-3"></div>
                </h2>

                <p className="text-dark/80 text-lg leading-relaxed mb-8">
                  At Agape Smart Solutions, your success is our mission. Our
                  all-encompassing program is designed to provide students with
                  the resources, guidance, and support. We are confident that
                  you will be well-prepared to pass your HESI exam and move
                  forward in your nursing education.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  "Progress tracking to evaluate performance and identify improvement areas",
                ].map((feature, index) => (
              ...
              {/* Call to Action */}
              <div className="pt-8 border-t border-tertiary/20">
                <div className="bg-primary/5 rounded-2xl p-6">
                  <h3 className="text-xl font-bold text-primary mb-3">
                    🚀 Start Your Nursing Career Today!
                  </h3>
                  <p className="text-dark/80 leading-relaxed">
                    Join us today and start your journey to a successful nursing
                    career with our comprehensive HESI preparation program.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section id="subscriptions" className="py-16 bg-tertiary/10">
        <div className="container mx-auto px-4 lg:px-8">
          <Subscriptions close={false} serviceName="HESI" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-dark/70 text-lg max-w-2xl mx-auto">
              Prepare for your nursing entrance exam with our expertly crafted
              HESI practice tests
            </p>
          </div>
            ...
            <div className="bg-tertiary/10 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {subjects?.()?.HESI?.map((item, index) => (
                  ...
                  // Fallback if HESI subjects are not available
                  [
                    "Math",
                    "Reading",
                    "Vocabulary",
...
export default HESIPracticeTest;
