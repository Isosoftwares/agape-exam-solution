...
function SideNav({ mobileMenu, handleMenu }) {
      ...
      links: [
        {
          ...
          path: `/hesi/test/Priority Premium Test`,
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "Bonus Practice Test",
          path: `/hesi/test/Bonus Practice Test`,
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "Take HESI On my Behalf",
          path: "/hesi/take-my-test/hesi",
          icon: <FaAngleRight size={18} />,
        },
        {
          name: "My HESI Exams",
          path: "/hesi/exams/HESI",
          icon: <FaAngleRight size={18} />,
        },
      ],
    },
  ...
  const subscription = getSubscription(auth.subscription, "HESI");
