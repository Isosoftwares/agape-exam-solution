...
function GEDOverview() {
  ...
  function checkSubscription(subscriptions, serviceName) {
    ...
    return hasSubscription ? "/ged/test/Priority Premium Test" : "/ged/test/Free";
  }
  const pathName = checkSubscription(auth?.subscription, "GED");

  const subjects = [
    {
      name: "English",
      icon: <MdOutlineMenuBook color="#4C3BCF" size={50} />,
      link: "/ged/test/Priority Premium Test",
      description:
        "This is subject description on why to take the test and review your test papers anytime you need to.",
    },
    {
      name: "Social Studies",
      icon: <RiGlobeLine color="#508D4E" size={50} />,
      link: "/ged/test/Priority Premium Test",
      description:
        "This is subject description on why to take the test and review your test papers anytime you need to.",
    },
        ...
        <div className="mx-auto py-4 flex flex-col md:flex-row space-y-4">
          ...
          <div className="p-4 rounded-lg w-full">
            ...
            <div className="flex justify-start gap-4">
              <button
                className={` ${
                  checkSubscriptionBool(auth?.subscription, "GED") && "hidden"
          ...
          <div className="  p-4 rounded-lg w-full">
            <h2 className="text-start text-primary text-xl font-bold mb-2">
              Do You Have an Upcoming GED Exam?
            </h2>
            <p className="text-brown-500">
          ...
          {subjects.map((item, index) => {
            return (
              ...
              >
                ...
                <div className=" pb-2 ">
                  <p className="text-lg text-center mt-3 text-primary">
                    {item?.name}
                  </p>
                </div>
              </Link>
